...
gdjs.MenuCode.GDNewButtonObjects4= [];
gdjs.MenuCode.GDpumpfunObjects1= [];
gdjs.MenuCode.GDpumpfunObjects2= [];
gdjs.MenuCode.GDpumpfunObjects3= [];
gdjs.MenuCode.GDpumpfunObjects4= [];
gdjs.MenuCode.GDtwitteerObjects1= [];
gdjs.MenuCode.GDtwitteerObjects2= [];
gdjs.MenuCode.GDtwitteerObjects3= [];
gdjs.MenuCode.GDtwitteerObjects4= [];
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10292116);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10294084);
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("NewButton"), gdjs.MenuCode.GDNewButtonObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.MenuCode.GDNewButtonObjects1.length;i<l;++i) {
    if ( gdjs.MenuCode.GDNewButtonObjects1[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.MenuCode.GDNewButtonObjects1[k] = gdjs.MenuCode.GDNewButtonObjects1[i];
        ++k;
    }
}
gdjs.MenuCode.GDNewButtonObjects1.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.MenuCode.GDNewButtonObjects1.length;i<l;++i) {
    if ( gdjs.MenuCode.GDNewButtonObjects1[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
...
if (isConditionTrue_0) {
{gdjs.evtTools.window.openURL("https://pump.fun/board", runtimeScene);
}}
...
gdjs.copyArray(runtimeScene.getObjects("twitteer"), gdjs.MenuCode.GDtwitteerObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.MenuCode.GDtwitteerObjects1.length;i<l;++i) {
    if ( gdjs.MenuCode.GDtwitteerObjects1[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.MenuCode.GDtwitteerObjects1[k] = gdjs.MenuCode.GDtwitteerObjects1[i];
        ++k;
    }
}
...
gdjs.MenuCode.GDNewButtonObjects4.length = 0;
gdjs.MenuCode.GDpumpfunObjects1.length = 0;
gdjs.MenuCode.GDpumpfunObjects2.length = 0;
gdjs.MenuCode.GDpumpfunObjects3.length = 0;
gdjs.MenuCode.GDpumpfunObjects4.length = 0;
gdjs.MenuCode.GDtwitteerObjects1.length = 0;
gdjs.MenuCode.GDtwitteerObjects2.length = 0;
gdjs.MenuCode.GDtwitteerObjects3.length = 0;
gdjs.MenuCode.GDtwitteerObjects4.length = 0;
